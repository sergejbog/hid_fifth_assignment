<script lang="ts">
	...
	import { youngPostsStore } from '$lib/dummyData';

	let searchQuery = '';
	let selectedCategory = '';

	$: filteredPosts = $youngPostsStore.filter(
		(post) =>
	...
	function likePost(id: number) {
		$youngPostsStore = $youngPostsStore.map((post) =>
...
<svelte:head>
	<title>Harmony Exchange - Young</title>
</svelte:head>

<div class="mx-auto max-w-3xl">
	<h1 class="mb-6 text-3xl font-bold">Young Generation Posts</h1>
